...
file = './config/parameter_256_3.ini'
...
with tf.Session() as sess:
    ...
    vali_data_list = vali_data_list[:25600]
    vali_label_list = vali_label_list[:25600]
    ...
    for epoch in range(epoch_num):
        ...
        for step in range(1,training_steps+1):
            ...
            batch_data = batch_data.reshape((batch_size*256,1,num_input))
            # 现在开始训练

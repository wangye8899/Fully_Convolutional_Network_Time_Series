...
import configparser
from LSTM_FCN_model_1024_3_5 import LSTM_FCN
...
# 'conv4':tf.Variable(init([3,128,64])),
# 'conv5':tf.Variable(init([3,64,32])),
# 'conv6':tf.Variable(init([3,32,32])),

...
from file_utils128 import read_file_and_to_numpy
from file_utils128 import read_file_and_to_numpy_val
file = './config/parameter_128.ini'
...
with tf.Session() as sess:
    ...
    for epoch in range(epoch_num):
        ...
        for step in range(1,training_steps+1):
            ...
            batch_data = batch_data.reshape((batch_size*128,1,num_input))
            # 现在开始训练

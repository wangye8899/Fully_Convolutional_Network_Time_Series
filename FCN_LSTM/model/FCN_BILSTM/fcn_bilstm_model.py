...
class LSTM_FCN:
    ...
    def __init__(self,bilstm_x,fcn_x,weights,biases,num_hidden):
        self.bilstm_x = bilstm_x
        self.fcn_x = fcn_x
    ...
    def FCN_(self):
        ...
        # print(np.array(x))
        # 第一层卷积
        conv1 = tf.nn.conv1d(self.fcn_x,self.weights['conv1'],1,'SAME')
    ...
    def Connect(con1,con2):
        out = tf.concat([con1,con2],1)
        return_out = tf.matmul(out,self.weights['out_w'])+self.biases['out_b']
        return return_out

...
def generate_vector(file,data_list,label_list,num,num_file,j):
    ...
    for i in range(len(data_list)): 
        ...
        if i>=5 and i<=122:
            # print(i)
            pri_.append([data_list[i]-data_list[i-5],data_list[i]-data_list[i-4],data_list[i]-data_list[i-3],data_list[i]-data_list[i-2],data_list[i]-data_list[i-1],data_list[i+1]-data_list[i],data_list[i+2]-data_list[i],data_list[i+3]-data_list[i],\
            ...
            pri_.append([0,0,0,0,0,data_list[1]-data_list[i],data_list[2]-data_list[i],data_list[3]-data_list[i],data_list[4]-data_list[i],data_list[5]-data_list[i]])
            # print(i)z
            # print(len(pri_[i]))
            # pri_ = []
        elif i==1:
            pri_.append([0,0,0,0,data_list[i]-data_list[0],data_list[2]-data_list[i],data_list[3]-data_list[i],data_list[4]-data_list[i],data_list[5]-data_list[i],data_list[6]-data_list[i]])
            # print(i)
            # print(len(pri_[i]))
        elif i==2:
            pri_.append([0,0,0,data_list[i]-data_list[0],data_list[i]-data_list[1],data_list[3]-data_list[i],data_list[4]-data_list[i],data_list[5]-data_list[i],data_list[6]-data_list[i],data_list[7]-data_list[i]])
            # print(i)
            # print(len(pri_[i]))
        elif i==3:
            pri_.append([0,0,data_list[i]-data_list[0],data_list[i]-data_list[1],data_list[i]-data_list[2],data_list[4]-data_list[i],data_list[5]-data_list[i],data_list[6]-data_list[i],data_list[7]-data_list[i],data_list[8]-data_list[i]])
            # print(i)
            # print(len(pri_[i]))
        elif i==4:
            pri_.append([0,data_list[i]-data_list[0],data_list[i]-data_list[1],data_list[i]-data_list[2],data_list[i]-data_list[3],data_list[5]-data_list[i],data_list[6]-data_list[i],data_list[7]-data_list[i],data_list[8]-data_list[i],data_list[9]-data_list[i]])
            # print(i)
            # print(len(pri_[i]))
        elif i==123:
            pri_.append([data_list[i]-data_list[i-5],data_list[i]-data_list[i-4],data_list[i]-data_list[i-3],data_list[i]-data_list[i-2],data_list[i]-data_list[i-1],data_list[124]-data_list[i],data_list[125]-data_list[i],data_list[126]-data_list[i],data_list[127]-data_list[i],0])
            # print(i)
            # print(len(pri_[i]))
        elif i==124:
            pri_.append([data_list[i]-data_list[i-5],data_list[i]-data_list[i-4],data_list[i]-data_list[i-3],data_list[i]-data_list[i-2],data_list[i]-data_list[i-1],data_list[125]-data_list[i],data_list[126]-data_list[i],data_list[127]-data_list[i],0,0])
            # print(i)
            # print(len(pri_[i]))
        elif i==125:
            pri_.append([data_list[i]-data_list[i-5],data_list[i]-data_list[i-4],data_list[i]-data_list[i-3],data_list[i]-data_list[i-2],data_list[i]-data_list[i-1],data_list[126]-data_list[i],data_list[127]-data_list[i],0,0,0])            # all_pri.append(pri_)
            # print(i)
            # print(len(pri_[i]))
        elif i==126:
            pri_.append([data_list[i]-data_list[i-5],data_list[i]-data_list[i-4],data_list[i]-data_list[i-3],data_list[i]-data_list[i-2],data_list[i]-data_list[i-1],data_list[127]-data_list[i],0,0,0,0])
            # print(i)
            # print(len(pri_[i]))
        elif i==127:   
            pri_.append([data_list[i]-data_list[i-5],data_list[i]-data_list[i-4],data_list[i]-data_list[i-3],data_list[i]-data_list[i-2],data_list[i]-data_list[i-1],0,0,0,0,0])
            # print(i)
            # print(len(pri_[i]))

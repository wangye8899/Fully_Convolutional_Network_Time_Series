...
if __name__ == "__main__":
    ...
    read_file_and_get_data('/home/wang/Radar数据/Deinterleaving/data/5_512/train/',0)
    read_file_and_get_data('/home/wang/Radar数据/Deinterleaving/data/5_512/test/',1)
    read_file_and_get_data('/home/wang/Radar数据/Deinterleaving/data/5_512/val/',2)
